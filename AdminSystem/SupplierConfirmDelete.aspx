...
<body>
    <form id="form1" runat="server">
        ...
        Are you sure you want to delete this record?<asp:Button ID="btnYes" runat="server" OnClick="btnYes_Click" style="z-index: 1; left: 92px; top: 94px; position: absolute" Text="Yes" />
